...
//      {
//      case MINER_FULL:
//         action.entity.executeMinerFullActivity(this, action.world,
//            action.imageStore, scheduler);
//         break;
//
//      case MINER_NOT_FULL:
//         action.entity.executeMinerNotFullActivity(this, action.world,
//            action.imageStore, scheduler);
//         break;
//
//      case ORE:
//         action.entity.executeOreActivity(this, action.world, action.imageStore,
//            scheduler);
//         break;
//
//      case ORE_BLOB:
//         action.entity.executeOreBlobActivity(this, action.world,
//            action.imageStore, scheduler);
//         break;
//
//      case QUAKE:
...
//
//      case VEIN:
//         action.entity.executeVeinActivity(this, action.world, action.imageStore,
//            scheduler);
//         break;
//
//      default:
...
//            entity.actionPeriod);
//         scheduleEvent(scheduler, entity, entity.createAnimationAction(0),
...
//            entity.actionPeriod);
//         scheduleEvent(scheduler, entity,
//            entity.createAnimationAction(0), entity.getAnimationPeriod(this));
//         break;
//
//      case ORE:
//         scheduleEvent(scheduler, entity,
...
//         miner.scheduleActions(this, scheduler, world, imageStore);
//
//         return true;
//      }
//
...
//            if (world.withinBounds(this, newPt) &&
//               !world.isOccupied(this, newPt))
//            {
...
//         
//         scheduler.removePendingEvent(this, next);
//         
//         next.action.executeAction(this, scheduler);
//      }
//   }
...
//         {
//         case BGND_KEY:
//            return world.parseBackground(properties, this, imageStore);
//         case MINER_KEY:
//            return world.parseMiner(properties, this, imageStore);
//         case OBSTACLE_KEY:
//            return world.parseObstacle(properties, this, imageStore);
//         case ORE_KEY:
//            return world.parseOre(properties, this, imageStore);
//         case SMITH_KEY:
//            return world.parseSmith(properties, this, imageStore);
//         case VEIN_KEY:
//            return world.parseVein(properties, this, imageStore);
//         }
//      }
//
//      return false;
...
//            new Background(id, imageStore.getImageList(this, id)));
//      }
//
...
//            imageStore.getImageList(this, MINER_KEY));
...
//            pt, imageStore.getImageList(this, OBSTACLE_KEY));
//         tryAddEntity(world, entity);
//      }
//
...
//            imageStore.getImageList(this, ORE_KEY));
//         tryAddEntity(world, entity);
//      }
//
...
//            pt, imageStore.getImageList(this, SMITH_KEY));
//         tryAddEntity(world, entity);
//      }
//
...
//            imageStore.getImageList(this, VEIN_KEY));
//         tryAddEntity(world, entity);
//      }
//
...
//   {
//      if (world.isOccupied(this, entity.position))
//      {
...
//   {
//      return world.withinBounds(this, pos) &&
//         world.getOccupancyCell(this, pos) != null;
//   }
...
//         int nearestDistance = nearest.position.distanceSquared(this, pos);
//
//         for (Entity other : entities)
//         {
//            int otherDistance = other.position.distanceSquared(this, pos);
//
...
//      Point pos)
//   {
//      if (world.withinBounds(this, pos))
//      {
...
//
//      view.viewport.shift(this, newCol, newRow);
//   }
...
//         {
//            Point worldPoint = view.viewport.viewportToWorld(this, col, row);
...
//
//         if (view.viewport.contains(this, pos))
//         {
//            Point viewPoint = view.viewport.worldToViewport(this, pos.x, pos.y);
